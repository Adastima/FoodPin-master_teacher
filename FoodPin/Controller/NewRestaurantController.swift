...
class NewRestaurantController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func saveButtonTapped(sender: AnyObject) {
        ...
        if nameTextField.text == "" || typeTextField.text == "" || addressTextField.text == "" || phoneTextField.text == "" || summaryTextView.text == "" {
        ...
        let newValue = Restaurant(name: nameTextField.text!, type: typeTextField.text!, location: addressTextField.text!, phone: phoneTextField.text!, summary: summaryTextView.text!, image: selectedImageName, isVisited: false)
